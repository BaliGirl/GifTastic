$(document).ready(function () {
	var movies = ["james bond", "moulin rouge", "clueless", "mean girls", "drop dead fred", "breakfast at tiffanys", "cruel intentions", "donnie darko", "a night at the roxbury"];
	...
	$("button").on("click", function () {
		...
		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
			movie + "&api_key=cK5t74FguzCLXVYhtkfXGxZx3vA552SW&limit=10"
    ...
    // API cK5t74FguzCLXVYhtkfXGxZx3vA552SW
