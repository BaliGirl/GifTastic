$(document).ready(function () {
    var movies = ["james bond", "the matrix", "harry porter", "toy story", "minions", "home alone", "shrek", "star wars", "jurassic world", "jumanji", "avatar", "grease", "forrest gump", "fast and furious", "transformers", "the twilight"];
    ...
    $("button").on("click", function () {
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
            movie + "&api_key=cK5t74FguzCLXVYhtkfXGxZx3vA552SW"
